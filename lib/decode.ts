import * as Superstruct from "../deps/superstruct.ts";
import { StructError, validate } from "../deps/superstruct.ts";
import type { Describe, Struct } from "../deps/superstruct.ts";
